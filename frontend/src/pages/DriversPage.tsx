...
export default function DriversPage() {
  ...
  // Sort by team name, then by points descending within each team
  ...
  // Group by team for visual sections
  const teamGroups: { team: string; colour: string; drivers: DriverData[] }[] = [];
  let currentTeam = '';
  let currentGroup: typeof teamGroups[0] | null = null;
  for (const d of sortedDrivers) {
    if (d.team_name !== currentTeam) {
      currentTeam = d.team_name;
      currentGroup = { team: d.team_name, colour: d.team_colour, drivers: [] };
            ...
            <div key={group.team}>
              ...
              <div className="flex items-center gap-2 mb-3 pb-2 border-b border-border/50">
                <span
                  ...
                  style={{ background: teamColor(group.colour) }}
                />
                <h2 className="text-lg font-semibold">{group.team}</h2>
